...
def plot_count(img, count):
    # Plots one bounding box on image img
    text = 'banana count: %s' % str(count)
    print(img.shape)
    cv2.putText(img, text, (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2, cv2.LINE_AA)
